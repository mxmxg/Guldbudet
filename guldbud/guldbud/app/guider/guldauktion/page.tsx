...
const faq = [
  ...
  },
  {
    ...
    a: 'Ja. Alla handlare är manuellt verifierade med organisationsnummer och legitimation. När du accepterat ditt slutpris skickar vi ett kostnadsfritt, rekommenderat brev med förbetalt porto, försäkrat. Vi äkthetskontrollerar föremålet, och du får betalt spårbart till ditt bankkonto inom 24 timmar, aldrig kontant i handen.',
  },
]
