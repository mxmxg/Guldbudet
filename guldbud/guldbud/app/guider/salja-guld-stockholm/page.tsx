...
const faq = [
  ...
  },
  {
    ...
    a: 'När vi tagit emot och äkthetskontrollerat föremålet betalar vi ut via Swish eller bankkonto, normalt inom 1–2 bankdagar. Att sälja är kostnadsfritt för dig.',
  },
]
