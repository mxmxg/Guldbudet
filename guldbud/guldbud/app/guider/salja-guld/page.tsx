...
const faq = [
  ...
  },
  {
    ...
    a: 'När du godkänt ditt slutpris skickar vi dig ett kostnadsfritt, rekommenderat brev med förbetalt porto, försäkrat upp till 100 000 kr. Du lägger föremålet i det och postar det rekommenderat, porto och adress är redan klara. Vi äkthetskontrollerar det och betalar ut till dig inom 24 timmar via Swish eller bankkonto.',
  },
  {
