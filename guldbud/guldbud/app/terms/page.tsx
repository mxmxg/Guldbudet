      ...
      sections={[
        {
          ...
          body: [
            ...
            'GuldBud tillhandahåller egna tjänster i form av förmedling, kontroll av föremål, förmedling av betalningsuppgifter och transport enligt dessa villkor.',
            'Handlaren betalar köpeskillingen direkt till säljaren. GuldBud tar inte emot säljarens köpeskilling och gör inget avdrag från den. GuldBuds ersättning betalas av handlaren separat och är inte en del av köpeskillingen.',
            'Inom ramen för förmedlingsuppdraget åtar sig GuldBud att:',
          ],
          bullets: [
            'tillvarata ditt intresse och utföra uppdraget med omsorg,',
            'hålla dig underrättad om bud, accept, mottagande, kontroll och betalning,',
            'aldrig ta emot din köpeskilling, handlaren betalar den direkt till dig,',
            'redovisa affären för dig genom det underlag som tillhandahålls i tjänsten,',
            'se till att du får hela din köpeskilling utan avdrag enligt dessa villkor,',
        ...
        },
        {
          ...
          body: [
            ...
            'Du legitimerar dig med BankID innan du kan lägga ut ditt första föremål. GuldBud kan därutöver komma att verifiera din identitet på nytt före betalning.',
        ...
        },
        {
          ...
          body: [
            'Efter att säljaren accepterat det vinnande budet tillhandahåller GuldBud ett kostnadsfritt, rekommenderat brev med förbetalt porto, försäkrat.',
        ...
        },
        {
          ...
          body: [
            ...
            'Kommer ingen ny överenskommelse till stånd ska handlaren inte betala köpeskillingen, GuldBuds faktura till handlaren krediteras, och föremålet returneras kostnadsfritt till säljaren.',
        ...
        },
        {
          ...
          body: [
            ...
            'När föremålet har godkänts genom kontroll betalar handlaren säljarens köpeskilling direkt till det bankkonto som säljaren angett i inloggat läge, inom 24 timmar från GuldBuds besked om godkänd kontroll. Tiden tills beloppet syns på säljarens konto beror därefter på bankernas handläggning. Säljaren bekräftar i tjänsten att betalningen mottagits, varefter GuldBud skickar föremålet till handlaren. Säljaren ansvarar för att angivna konto- och clearinguppgifter är korrekta och att kontot står i säljarens eget namn.',
            'GuldBud tar inte emot köpeskillingen och gör inget avdrag från den. GuldBud har inte rätt till säljarens köpeskilling utöver den ersättning som uttryckligen avser GuldBuds egna tjänster och som handlaren betalar.',
        ...
        },
        {
          ...
          body: [
            'GuldBud har rätt att kontakta säljaren för att verifiera identitet, bekräfta lämnade uppgifter eller kontrollera omständigheter kring ett föremål eller en affär innan föremålet skickas vidare.',
          ],
        },
        {
          heading: 'Meddelanden',
