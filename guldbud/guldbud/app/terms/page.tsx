      ...
      sections={[
        ...
        },
        {
          ...
          body: [
            ...
            'När föremålet har godkänts genom kontroll administrerar GuldBud utbetalningen av säljarens köpeskilling inom 24 timmar via banköverföring. Utbetalning sker till det bankkonto som säljaren anger i inloggat läge. Säljaren ansvarar för att angivna konto- och clearinguppgifter är korrekta.',
