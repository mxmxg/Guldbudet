...
from (
  ...
  from (values
    ...
    ('Ankarlänk i gult guld',       'Halsband',  'Kraftig ankarlänk, 50 cm. Stämplad och kontrollerad.',                     22.5, '18K / 750', null,  null,       9000,  16),
    ...
    ('Guldmynt, Krugerrand 1 oz',   'Mynt',      'Investeringsmynt i 22K guld, 1 troy ounce. Utmärkt skick.',                 33.9, '22K / 916', null,  null,       18000, 40),
...
begin
  ...
  loop
    v_base := greatest(500, round(coalesce(v_item.weight_grams, 5) * 480));
